...
const config = {
  bondYields: {
    ...
    desc: 'The US 10-year Treasury yield, UK 10-year gilt yield and German bund yield have decreased over more than three decades.',
    yAxisLabel: '%',
    yScale: [-1, 16],
  ...
  assetsLiabilities: {
    ...
    desc: 'The gap between assets and liabilities is growing.',
    areaLabel: 'Liability gap',
    areaLabelPlacement: { x: '01-Jan-2016', y: 260 },
    mobileAreaLabelPlacement: { x: '01-Jan-2016', y: 218 },
